...
* Skills: To support a language, a Skill must have `vocab` and `dialog` entries for that language. [See here for more information on how Skills are structured](https://mycroft.ai/documentation/skills/introduction-developing-skills/#structure-of-the-skill-repo).
