...
layout: post
permalink: >
  http://mycroft.ai/blog/19-02-release-notes-mycroft-major-release-3/
published: true
...
<h1>Mycroft Core</h1>
Technically, all of the pieces that make up Mycroft are brought together by <a href="https://github.com/mycroftai/mycroft-core" target="_blank" rel="noopener noreferrer">Mycroft Core</a>. This framework allows technologies created by individuals and teams from around the world to work in harmony.
...
Built on KDE Plasma technology, the <a href="https://github.com/mycroftai/mycroft-gui" target="_blank" rel="noopener noreferrer">Mycroft GUI</a> allows voice interfaces and graphical interfaces to augment each other. A future blog post will go into deeper detail about this technology.
...
Also, the <a href="https://github.com/MycroftAI/mycroft-core/releases" target="_blank" rel="noopener noreferrer">19.02.0 release</a> is also our 101st successful bi-weekly release of mycroft-core!
...
We've released a <a href="https://github.com/MycroftAI/mimic-recording-studio" target="_blank" rel="noopener noreferrer">Recording Studio</a> with all the tools for an individual to generate the recordings needed to build a voice in ANY language.
<h3>Mimic server</h3>
Tooling to support running Mimic2, GPU-intensive voices in a shared server environment.
<h3>Mimic Pronounce</h3>
<a href="https://mimic.mycroft.ai/pronounce" target="_blank" rel="noopener noreferrer">Pronounce is a Community tool</a> for teaching Mimic voices to sound better.
...
<a href="https://translate.mycroft.ai/" target="_blank" rel="noopener noreferrer">This tool</a> is empowering language communities to create their own voice assistant. Over a dozen languages have been fully translated, with nearly 50 languages underway.
...
Beyond the original Skills Management Team (the official owner of the <a href="https://github.com/mycroftai/mycroft-skills" target="_blank" rel="noopener noreferrer">Mycroft Skills</a> repo), we have added the following teams over the last few months:
...
This team is Community members working to guarantee Skills work for everyone. If you're interested, <a href="https://goo.gl/forms/mTSRlAsMaMjelX482" target="_blank" rel="noopener noreferrer">fill out this form</a>!
...
<h3>Marketplace</h3>
Exploring and installing Skills is now easy with a modern interface. <a href="https://market.mycroft.ai/" target="_blank" rel="noopener noreferrer">Check out some new skills</a>!
<h3>Our new Home</h3>
...
Building on the original work of Jarbas, an <a href="https://github.com/MycroftAI/personal-backend" target="_blank" rel="noopener noreferrer">official community project</a> has launched to with the goal of providing the ultimate privacy guarantee – self-hosting.
<h1>Skills!</h1>
...
<a href="https://market.mycroft.ai/skill/theia-ide" target="_blank" rel="noopener noreferrer">Theia</a> on-device development/debugger
